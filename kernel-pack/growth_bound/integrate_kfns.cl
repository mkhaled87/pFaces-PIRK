    ...
    __global float *t)
{
    ...
    k0[i] = dynfn(final_state, input, *t, i);
...
__kernel void gb_integrate_dynchoice_5( 
    __global float *initial_state,
    __global float *final_state, 
    __global float *input,
    __global float *k0,
...
__kernel void gb_integrate_dynchoice_6( 
    __global float *initial_state,
    __global float *final_state, 
    __global float *input,
    __global float *k0,
...
__kernel void gb_integrate_dynchoice_7( 
    __global float *initial_state,
    __global float *final_state, 
    __global float *input,
    __global float *k0,
...
__kernel void gb_integrate_dynchoice_8( 
    __global float *initial_state,
    __global float *final_state, 
    __global float *input,
    __global float *k0,
