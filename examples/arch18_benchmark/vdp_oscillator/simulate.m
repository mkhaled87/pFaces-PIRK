...
for t=initial_time:step_size:(final_time-step_size)
    center(1) = center_pipe_file.getElement(2*step_idx);
    center(2) = center_pipe_file.getElement(2*step_idx+1);
    radius(1) = radius_pipe_file.getElement(2*step_idx);
    radius(2) = radius_pipe_file.getElement(2*step_idx+1);
