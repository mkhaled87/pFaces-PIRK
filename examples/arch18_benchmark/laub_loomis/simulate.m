...
% some cosntants
center_file_name = 'laub_loomis.result_gb_center.raw';
radius_file_name = 'laub_loomis.result_gb_radius.raw';
center_pipe_file_name = 'laub_loomis.result_gb_center_pipe.raw';
radius_pipe_file_name = 'laub_loomis.result_gb_radius_pipe.raw';
...
for t=initial_time:step_size:(final_time-step_size)
    ...
    lb_t = [lb_t (center(4)-radius(4))];
    ub_t = [ub_t (center(4)+radius(4))];
    cent_t = [cent_t center(4)];
